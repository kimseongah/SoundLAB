...
main_dir = 'C:/Users/kimsa/Documents/SoundLAB/기침소리/example1' 
...
for csv_file in csv_files:
    ...
    plt.savefig('C:/Users/kimsa/Documents/SoundLAB/기침소리/example1/image'+'/'+str(count)+'.png')
    plt.close()
    count +=1
...
import os
maindir = 'C:/Users/kimsa/Documents/SoundLAB/기침소리/example1/image'
for parent, dirnames, filenames in os.walk(maindir):        
 for filename in filenames:
        ...
        caijian.save('C:/Users/kimsa/Documents/SoundLAB/기침소리/example1/image'+filename)
